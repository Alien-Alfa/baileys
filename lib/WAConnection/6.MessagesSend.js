...
class WAConnection extends _5_User_1.WAConnection {
    ...
    async prepareMessageMedia(buffer, mediaType, options = {}) {
        ...
        for (let host of json.hosts) {
            ...
            try {
                const urlFetch = await this.fetchRequest(url, 'POST', body, options.uploadAgent, {
    ...
    prepareMessageFromContent(id, message, options) {
        ...
        const key = Object.keys(message)[0] == 'MessageType' ? 'extendedTextMessage' : Object.keys(message)[0];
        ...
        (((options === null || options === void 0 ? void 0 : options.sendEphemeral) === 'chat' && (chat === null || chat === void 0 ? void 0 : chat.ephemeral)) || (options === null || options === void 0 ? void 0 : options.sendEphemeral) === true) &&
    ...
    async updateMediaMessage(message) {
        var _a, _b, _c, _d, _e;
        const content = ((_a = message.message) === null || _a === void 0 ? void 0 : _a.audioMessage) ||
            ((_b = message.message) === null || _b === void 0 ? void 0 : _b.videoMessage) ||
            ((_c = message.message) === null || _c === void 0 ? void 0 : _c.imageMessage) ||
            ((_d = message.message) === null || _d === void 0 ? void 0 : _d.stickerMessage) ||
            ((_e = message.message) === null || _e === void 0 ? void 0 : _e.documentMessage);
        if (!content)
    ...
    async downloadMediaMessage(message) {
        ...
        try {
            ...
            if (error instanceof Constants_1.BaileysError && error.status === 404) {
                // media needs to be updated
    ...
    async generateLinkPreview(text) {
        ...
        const response = await this.query({
            json: query,
            binaryTags: [26, Constants_1.WAFlag.ignore],
            expect200: true,
    ...
    async refreshMediaConn(forceGet = false) {
        if (!this.mediaConn ||
            forceGet ||
            new Date().getTime() - this.mediaConn.fetchDate.getTime() > this.mediaConn.ttl * 1000) {
